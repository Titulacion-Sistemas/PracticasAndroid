...
public class CoordinateConversion
{
  ...
  public coordUTM latLon2UTM(double latitude, double longitude)
  {
  ...
  {
    public coordUTM convertLatLonToUTM(double latitude, double longitude)
    {
      ...
      UTM.setLongZone(getLongZone(longitude));
      LatZones latZones = new LatZones();
      UTM.setLatZone(latZones.getLatZone(latitude));
      UTM.setEasting(getEasting());
      UTM.setNorting(getNorthing(latitude));
